...
Drift CLI is in **open beta** (v1.0.15). It runs on Ubuntu 20.04+ with ROS2 and Gazebo Sim. Install Drift or [get started with the Quickstart](/getting-started/quickstart).
...
If you hit an issue, describe it at the `drift>` with a prompt, the agent will attempt to diagnose and recover. For persistent problems, [open an issue on GitHub](https://github.com/godrift-ai/drift-releases/issues).
