...
{/* TODO: Embed a short GIF or video here showing Drift in action — e.g., a user typing a natural language command and a robot appearing in Gazebo. Even a 10-second recording would be the single most impactful addition to this page. */}
...
- **ARM architecture** — Only x86_64 (amd64) is supported. Apple Silicon and Raspberry Pi are not yet supported.
