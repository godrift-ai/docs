...
While tools like Cursor or Claude are excellent for general coding and debugging, they miss context on robotics and that's what Drift eliminates.

In the video below, we tried solving a same Gazebo error using Claude and Drift. 
...
<Frame>
  <video autoPlay loop muted playsInline>
    <source src="/assets/videos/drift-vs-cursor.mp4" type="video/mp4" />
  </video>
</Frame>
