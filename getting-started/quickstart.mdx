...
First time launching from a fresh directory, Drift will nudge you to run `/init` — that's the project-memory bootstrap (see Step 3).
...
<Tabs>
  ...
  <Tab title="MuJoCo">
    ...
    drop it in a 5×5m floor scene, drive it forward 5 seconds, and log
    IMU + chassis pose to a CSV
    ```
  </Tab>
</Tabs>
