---
title: "Launch Manipulator Arm in RViz"
description: "Build a manipulator arm simulation and inspect it live in RViz using only natural language prompts"
---

One prompt. A 3-joint manipulator arm with a realistic end effector, built and launched in RViz- no URDF written, no launch file configured.
